...
class _LoadingScreenState2 extends State<LoadingScreen2> {
  ...
  int sintomas(i) {
    if (i == 'COVID-19') {
      ...
      return 5;
    } else if (i == 'Producto caducado administrado') {
      return 6;
    } else if (i == 'Dolor de cabeza') {
      return 7;
    } else if (i == 'Astenia') {
      return 8;
    } else if (i == 'Pirexia') {
      ...
      return 10;
    } else if (i == 'Dolor en la extremidad') {
      return 11;
    } else if (i == 'Eritema en el sitio de inyección') {
      return 12;
    } else if (i == 'Error en el almacenamiento del producto') {
      return 13;
    } else if (i == 'Eritema') {
      return 14;
    } else if (i == 'Sin evento adverso') {
      return 15;
    } else if (i == 'Náuseas') {
      return 16;
    } else if (i == 'Erupción') {
      ...
      return 19;
    } else if (i == 'Análisis de sangre') {
      return 20;
    } else if (i == 'Dolor en el lugar de la inyección') {
      return 21;
    } else if (i == 'Tos') {
      return 22;
    } else if (i == 'SARS-CoV-2 prueba positiva') {
      return 23;
    } else if (i == 'Prurito en el lugar de la inyección') {
      return 24;
    } else if (i == 'Mialgia') {
      return 25;
    } else if (i == 'Sentirse anormal') {
      return 26;
    } else if (i == 'Prueba SARS-CoV-2') {
      return 27;
    } else if (i == 'Diarrea') {
      return 28;
    } else if (i == 'Dolor de espalda') {
      return 29;
    } else {
      return 0;
    }
